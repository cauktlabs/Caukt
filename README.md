...
<p align="center">
  <a href="https://aukt.click"><img src="https://img.shields.io/badge/web-aukt.click-1A2E4A?style=for-the-badge" alt="Website" /></a>
  <a href="https://github.com/auktdev/aukt"><img src="https://img.shields.io/badge/github-auktLabs%2Faukt-1A2E4A?style=for-the-badge" alt="GitHub" /></a>
...
Aukt is a pixel-art side-scrolling Dutch auction marketplace for Base. Walk through a 16-bit dawn fish market. Approach a stall. Press E. The auctioneer rings the brass bell and the price drops one notch at a time. The first bid takes.

Live on mainnet at [aukt.click](https://aukt.click). Holder score + tiered rounds at [aukt.click/score](https://aukt.click/score).
...
| Surface        | URL                                  |
|----------------|--------------------------------------|
| Pixel hall     | https://aukt.click                     |
| Live stalls    | https://aukt.click/market              |
| Open a stall   | https://aukt.click/launch              |
| Your score     | https://aukt.click/score               |
| Top holders    | https://aukt.click/leaderboard         |
| Your stalls    | https://aukt.click/account             |
| Docs           | https://aukt.click/docs                |
...
The deploy pipelines for `aukt.click` and `api.aukt.click` live in private mirrors; this public repo carries the design notes, prototypes, and community artifacts that anyone is free to read, fork, and build on.

## Opening sequence

Everything below is already coded and shipped. These are not future promises — they are doors getting unlocked, in order.

- `[BUILT · WALKING NOW]` Pixel hall — side-scrolling 16-bit market with parallax stalls, auctioneer animations, and live BGM. Live at `aukt.click`.
- `[BUILT · CA OPENING]` $AUKT token — uniswap fair launch, no presale, no team allocation. CA badge auto-pins to the header the moment the mint goes live.
...
| Where          | Handle                            |
|----------------|-----------------------------------|
| Web            | https://aukt.click                  |
| X / Twitter    | https://x.com/auktdotfun          |
| Telegram bot   | https://t.me/aukt_market_bot      |
| Email          | hello@aukt.click                    |
